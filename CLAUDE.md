...
- **広告**（AdSense/アフィリエイト）は「他人が見ても不快でない・見られても恥ずかしくない・読者の邪魔にならない（むしろ助かる）」を満たすこと。満たすなら位置は問わない（2026-08-21改定）。必須条件=「広告」ラベル・高さ予約・区切り・数を絞る・文章やリストの途中を割らない。入力フォーム上部/中間、フッターより下、アンカー/オーバーレイ/Auto Adsは引き続き禁止。新設・移動はユーザー確認必須
